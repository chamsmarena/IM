...
if(isset($_SESSION["USER"])){
	...
	$requete = "SELECT ID_LIEU, ID_A1, CODE_LIEU, LIBELLE_LIEU FROM LIEU WHERE ID_LIEU = ?";
	$infoAdmin1 = null;
	...
	try{
		if ($stmt->execute(array($idLieu))){
			while ($row = $stmt->fetch()) {
				$infoAdmin1 = array($row['ID_LIEU'],$row['ID_A1'],$row['CODE_LIEU'],$row['LIBELLE_LIEU']);
			}
		}else{
			echo "noLines";
		}
        ...
        <div class="row dataBar">
			...
			<div class='col-lg-8'>
				<div class="zoneDetails">
					<div>	
						<span class="texteMoyen blocDanger"><span class='ion-edit' ></span> Editing Places</span>
					</div>
					<form class="form-horizontal" action="scripts/UpdateLieu.php" method="post">
						<div class="col-lg-12">
							...
							<div class="col-xs-12">
								<table>
									...
									<tr>
										<td>
											<input name='code' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[2];?>'/>
										</td>
									</tr>
								</table>
							</div>
							<div class="col-xs-12">
								<table>
									...
									<tr>
										<td>
											<input name='caption' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[3];?>'/>
										</td>
									</tr>
								</table>
							</div>
						...
						<div class="col-lg-12">
							...
							<input name='idLieu' hidden='hidden' type="text"  value='<?php echo $idLieu;?>'/>
						</div>
					</form>
				</div>

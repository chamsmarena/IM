...
if(isset($_SESSION["USER"])){
	...
	try{
		if ($stmt->execute(array($idAmin1))){
			while ($row = $stmt->fetch()) {
				$infoAdmin1 = array($row['ID_A1'],$row['CODE_A1'],$row['CAPTION_A1'],$row['COORD_X_A1'],$row['COORD_Y_A1'],$row['EST_CAPITALE']);
			}
		}else{
			echo "noLines";
		}
        ...
        <div class="row dataBar">
			...
			<div class='col-lg-8'>
				<div class="zoneDetails">
					<div>	
						<span class="texteMoyen blocDanger"><span class='ion-edit' ></span> Editing Admin 1</span>
					</div>
					<form class="form-horizontal" action="scripts/UpdateAdmin1.php" method="post">
						<div class="col-lg-12">
							...
							<div class="col-xs-12">
								<table>
									...
									<tr>
										<td>
											<input name='code' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[1];?>'/>
										</td>
									</tr>
								</table>
							</div>
							<div class="col-xs-12">
								<table>
									...
									<tr>
										<td>
											<input name='caption' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[2];?>'/>
										</td>
									</tr>
								</table>
							</div>
							<div class="col-xs-12">
								<table>
									<tr>
										<td>
											<span class='inputLabel' >Coord X</span>
										</td>
									</tr>
									<tr>
										<td>
											<input name='coordx' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[3];?>'/>
										</td>
									</tr>
								</table>
							</div>
							<div class="col-xs-12">
								<table>
									<tr>
										<td>
											<span class='inputLabel' >Coord Y</span>
										</td>
									</tr>
									<tr>
										<td>
											<input name='coordy' autocomplete="off" spellcheck="false" class="form-control" style='font-size:10px;height:27px;font-family: "Avenir Next","arial";' value='<?php echo $infoAdmin1[4];?>'/>
										</td>
									</tr>
								</table>
							</div>
						...
						<div class="col-lg-12">
							...
							<input name='idAdmin1' hidden='hidden' type="text"  value='<?php echo $idAmin1;?>'/>
						</div>
					</form>
				</div>
